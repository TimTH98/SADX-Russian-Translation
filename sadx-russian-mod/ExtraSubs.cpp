...
std::map<int, SubtitleData> ExtraSubs
{
	...
	{ 3, { "\aЭто режим испытаний, в котором\nможно переигрывать уровни.", 300, Menu } },
	...
	{ 390, { "\aНу что, погнали?", 120, Gameplay } }, //Sonic
	{ 392, { "\aНадо поторопиться.", 90, Gameplay } }, //Knuckles
	...
	{ 288, { "\aТак эта станция – центр города?", 180, Gameplay } }, //Sonic
	{ 289, { "\aМне нравятся железные дороги!", 150, Gameplay } }, //Tails
	...
	{ 293, { "\aПровожу анализ Стейшн-Сквер...", 180, Gameplay } }, //Gamma

	//Station Square - city hall area

	{ 274, { "\aТут так всё здорово поменялось!", 180, Gameplay } }, //Sonic
	...
	{ 286, { "\aДа я словно крыса!", 120, Gameplay } }, //Sonic
	...
	{ 294, { "\aЭй-эй, некогда прохлаждаться!", 210, Gameplay } }, //Sonic
	...
	{ 309, { "\aКак-то неуютно тут себя чувствую.", 150, Gameplay } }, //Amy
	{ 310, { "\aЛягушик, где же ты?", 120, Gameplay } }, //Big
	{ 311, { "\aПровожу анализ\nМистических руин...", 180, Gameplay } }, //Gamma

	//Mystic Ruins - Angel Island

	{ 312, { "\aТак это остров Ангела?", 150, Gameplay } }, //Sonic
	...
	{ 319, { "\aДойти до дома, что ли...", 120, Gameplay } }, //Big
	{ 320, { "\aТемпература повысилась.\nВключаю режим охлаждения.", 360, Gameplay } }, //Gamma

	//Final Egg entrance

	{ 321, { "\aТак здесь база Эггмана?", 150, Gameplay } }, //Sonic
	...
	{ 331, { "\aВот ужас!", 60, Gameplay } }, //Sonic
	...
	{ 339, { "\aКх-х... Он даже не скрывает\nсвои вкусы от подчинённых.", 300, Gameplay } }, //Sonic
	...
	{ 231, { "\aГде-то вдалеке слышно ветер.", 150, Gameplay } }, //Sonic
	{ 232, { "\aПодтверждено присутствие Е-103.", 180, Gameplay } }, //Gamma
	{ 233, { "\aНадо скорее выбираться отсюда!", 180, Gameplay } }, //Sonic
	{ 234, { "\aМеня занесло так высоко!", 150, Gameplay } }, //Sonic
	{ 235, { "\aИнтересно, куда делся Соник?", 180, Gameplay } }, //Tails

	//Casinopolis

	{ 236, { "\aХм-м... Пинбол, значит?", 120, Gameplay } }, //Sonic
	{ 237, { "\aКак-то тут ярко.", 60, Gameplay } }, //Knuckles
	{ 238, { "\aНу и вонища...\nЧто это за свалка такая?", 180, Gameplay } }, //Sonic

	//Icecap

	{ 239, { "\aУх-х... Ну и холодрыга!", 120, Gameplay } }, //Sonic
	{ 240, { "\aТут прям ледяной мир.", 150, Gameplay } }, //Sonic
	{ 241, { "\aЭтот лёд выглядит вкусно!", 150, Gameplay } }, //Big
	{ 242, { "\aСейчас покажу пару\nкрутых финтов!", 210, Gameplay } }, //Sonic
	...
	{ 251, { "\aМашины тут такие медленные,\nбудто и не едут толком!", 240, Gameplay } }, //Sonic
	{ 252, { "\aОсколки Изумруда должны быть\nгде-то в этом городе...", 270, Gameplay } }, //Knuckles

	//Red Mountain

	{ 253, { "\aКуда полетел Эгг-Крейсер?", 180, Gameplay } }, //Sonic
	{ 254, { "\aУф-ф...\nСвалюсь в лаву – и мне кранты.", 210, Gameplay } }, //Sonic
	{ 255, { "\aПодтверждено присутствие Е-104.", 180, Gameplay } }, //Gamma
	{ 256, { "\aЕсли свалюсь с обрыва, мне крышка.", 180, Gameplay } }, //Knuckles
	...
	{ 265, { "\aДа тут всё масло провоняло.", 150, Gameplay } }, //Sonic
	...
	{ 373, { "\aТак, и куда же его надо бить?", 180, Gameplay } }, //Chaos 6
	...
	{ 379, { "\aЯ смогу... Смогу сам!", 120, Gameplay } }, //Egg Walker
	...
	{ 348, { "\aКак же тут спокойно...", 150, Gameplay } },
	{ 349, { "\aЙо! Как жизнь?", 90, Gameplay } },
	{ 350, { "\aЭй, ребятки! А ну не драться!", 150, Gameplay } },

	//Tails

	{ 351, { "\aКак зайду сюда,\nна душе сразу так легко!", 210, Gameplay } },
	...
	{ 359, { "\aМалыши, не надо драться!", 150, Gameplay } },
	...
	{ 345, { "\aЧёрт! Песок в глазах!", 150, Gameplay } }, //Sonic
	...
	{ 1807, { "\aНу, не так уж и плохо.", 120, Gameplay } }, //normal clear
