...
std::map<int, SubtitleData> ExtraSubs
{
	...
	{ 112, { "Выберите персонажа,\nза которого будете играть.", 180, Menu } },
	{ 113, { "Как играть за Соника.", 120, Menu } },
	{ 114, { "Как играть за Тейлза.", 120, Menu } },
	{ 115, { "Как играть за Наклза.", 120, Menu } },
	{ 116, { "Как играть за Эми.", 120, Menu } },
	{ 117, { "Как играть за E-102 Гамму.", 120, Menu } }, //он даже не говорит "за меня"
	{ 118, { "Как играть за Бига.", 120, Menu } },
	{ 119, { "Как проходить основные уровни.\nОзнакомьтесь незамедлительно.", 300, Menu} },
	{ 120, { "Выберите уровень,\nна котором хотите поиграть.", 180, Menu } },
	{ 121, { "Выберите мини-игру.", 90, Menu } },
	{ 122, { "Экран настроек.\nЗдесь вы можете менять настройки.", 240, Menu } },
	{ 123, { "Тест звука.\nЗдесь вы можете слушать музыку из игры.", 240, Menu } },
	{ 124, { "Карта памяти не обнаружена.", 120, Menu } },
	{ 125, { "Внимание.\nНа карте памяти недостаточно места.", 180, Menu } },
	...
	{ 131, { "Как играть за ёжика.", 120, Menu } }, //harinezumi-kun
	{ 132, { "Как играть за лисёнка.", 120, Menu } }, //kitsune-kun
	{ 133, { "Как играть за ехидну.", 120, Menu } }, //mogura-kun (по идее, должна быть harimogura - ехидна, потому что просто mogura это крот)
	{ 134, { "Как играть за девочку.", 120, Menu } }, //onna no ko
	...
	{ 154, { "Как играть за того жирного кота, Бига.", 180, Menu } },
	...
	{ 161, { "На карте памяти недостаточно места.", 180, Menu } },
	...
	{ 303, { "Аж дух захватывает!", 120, Gameplay } }, //Amy
	...
	{ 306, { "Тут такое затишье.", 120, Gameplay } }, //Sonic
	...
	{ 346, { "По такому мягкому песку\nлегко скользить.", 210, Gameplay } }, //Tails
