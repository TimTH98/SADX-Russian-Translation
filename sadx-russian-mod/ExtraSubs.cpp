...
std::map<int, SubtitleData> ExtraSubs
{
	...
	{ 1767, { "Приготовления завершены.", 150, Menu } }, //Gamma
	...
	{ 291, { "Город с видом на море это так классно!", 210, Gameplay } }, //Amy
	...
	{ 302, { "Это ещё что за место?", 120, Gameplay } }, //Knuckles
	...
	{ 234, { "Как высоко меня занесло!", 150, Gameplay } }, //Sonic
	...
	{ 209, { "Ты вырвался вперёд!", 90, Gameplay } },
	...
	{ 1902, { "Му-ха-ха-ха-ха-ха-ха-ха!\nСоник! Попробуй-ка сюда добраться!", 300, Gameplay } }, //Egg Viper
	{ 1903, { "Соник, отведай-ка теперь этого!", 180, Gameplay } },
	...
	{ 1793, { "Хм, лаешь - да не кусаешь.", 120, Gameplay } }, //boss clear
	...
	{ 1733, { "Ура!", 60, Gameplay } }, //stage clear
	...
	{ 1723, { "Движемся в обратную сторону.\nСнизить скорость!", 240, Gameplay } }, //Eggman orders
	{ 1724, { "Движемся в обратную сторону.\nСнизить скорость!", 240, Gameplay } },
	{ 1725, { "Набираем высоту! Полный вперёд!", 180, Gameplay } },
	...
	{ 1809, { "Соник...", 60, Gameplay } }, //Tails
	{ 1796, { "Неужели... это конец?..", 90, Gameplay } }, //Knuckles
	{ 1740, { "О нет...", 60, Gameplay } }, //Amy
	{ 1755, { "О нет...", 60, Gameplay } }, //Big

	//Icecap (Tails) alternate snowboarding voices

	{ 1823, { "Ты вырвался вперёд!", 90, Gameplay } },
	{ 1824, { "Молодец!", 60, Gameplay } },
	{ 1825, { "Я впереди!", 60, Gameplay } },
	{ 1826, { "Победа за мной!", 60, Gameplay } },
	{ 1827, { "Неплохо!", 60, Gameplay } },
	{ 1829, { "Давай!", 60, Gameplay } },
	{ 1830, { "Я победил!", 60, Gameplay } },
	{ 1831, { "Начнём!", 60, Gameplay } },
	{ 1832, { "Держись!", 60, Gameplay } },
	{ 1833, { "По-по-подожди!", 90, Gameplay } },
	{ 1834, { "Постой!", 60, Gameplay } },
