...
std::map<int, SubtitleData> ExtraSubs
{
	...
	{ 274, { "\aЗдесь тоже всё здорово поменялось.", 180, Gameplay } }, //Sonic
	...
	{ 294, { "\aЭй-эй, сейчас не время прохлаждаться!", 210, Gameplay } }, //Sonic
	{ 295, { "\aТакой отель... Я даже завидую немного.", 210, Gameplay } }, //Tails
	{ 296, { "\aХм, курортный отель?", 120, Gameplay } }, //Knuckles
	{ 297, { "\aХотелось бы мне поселиться в таком отеле.", 210, Gameplay } }, //Amy
	...
	{ 242, { "\aСейчас покажу пару крутых приёмчиков!", 210, Gameplay } }, //Sonic
	...
	{ 254, { "\aХм-м... Если свалюсь в лаву, мне крышка.", 210, Gameplay } }, //Sonic
	...
	{ 260, { "\aОй-ой, да что происходит с этим кораблём?", 210, Gameplay } }, //Sonic
	...
	{ 368, { "\aДа что с ним такое? Он что, неуязвим?", 210, Gameplay } }, //Chaos 0
	{ 369, { "\aЧто бы ты ни предпринял, это бесполезно!", 240, Gameplay } }, //Egg Hornet
	...
	{ 1569, { "\aПоезд, следующий в Мистические руины,\nскоро отправится!", 300, Gameplay } },
	{ 1570, { "\aПоезд, следующий в Мистические руины,\nскоро отправится!", 300, Gameplay } },
	...
	{ 1843, { "\aЭй, парень! Поиграем потом ещё разок!", 180, Gameplay } }, //boss clear
	...
	{ 1747, { "\aЛягушик!", 60, Gameplay } }, //stage clear
	...
	{ 1727, { "\aПриближается сильный ветер.\nПриближается сильный ветер.", 300, Gameplay } },
	{ 1728, { "\aПредупреждение о сильном ветре отменено.", 210, Gameplay } },
